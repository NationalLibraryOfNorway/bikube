...
import okhttpfork.internal.duplex.MwsDuplexAccess
...
import okhttpfork.mockwebserver.SocketPolicy.CONTINUE_ALWAYS
import okhttpfork.mockwebserver.SocketPolicy.DISCONNECT_AFTER_REQUEST
import okhttpfork.mockwebserver.SocketPolicy.DISCONNECT_AT_END
import okhttpfork.mockwebserver.SocketPolicy.DISCONNECT_AT_START
import okhttpfork.mockwebserver.SocketPolicy.DISCONNECT_DURING_REQUEST_BODY
import okhttpfork.mockwebserver.SocketPolicy.DISCONNECT_DURING_RESPONSE_BODY
import okhttpfork.mockwebserver.SocketPolicy.DO_NOT_READ_REQUEST_BODY
import okhttpfork.mockwebserver.SocketPolicy.EXPECT_CONTINUE
import okhttpfork.mockwebserver.SocketPolicy.FAIL_HANDSHAKE
import okhttpfork.mockwebserver.SocketPolicy.NO_RESPONSE
import okhttpfork.mockwebserver.SocketPolicy.RESET_STREAM_AT_START
import okhttpfork.mockwebserver.SocketPolicy.SHUTDOWN_INPUT_AT_END
import okhttpfork.mockwebserver.SocketPolicy.SHUTDOWN_OUTPUT_AT_END
import okhttpfork.mockwebserver.SocketPolicy.SHUTDOWN_SERVER_AFTER_RESPONSE
import okhttpfork.mockwebserver.SocketPolicy.STALL_SOCKET_AT_START
import okhttpfork.mockwebserver.SocketPolicy.UPGRADE_TO_SSL_AT_END
import okhttpfork.mockwebserver.internal.duplex.DuplexResponseBody
import okio.Buffer
  ...
  private inner class Http2SocketHandler constructor(
    ...
    private fun pushPromises(
      ...
      for (pushPromise in promises) {
        ...
        requestQueue.add(
          RecordedRequest(requestLine, pushPromise.headers, chunkSizes, 0,
