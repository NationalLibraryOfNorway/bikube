...
class TitleControllerTest {
    ...
    fun `createTitle should return 200 OK with the created title`() {
        ...
        every { newspaperService.createNewspaperTitle(any()) } returns Mono.just(NewspaperMockData.Companion.newspaperTitleMockA.copy())

        titleController.createTitle(NewspaperMockData.Companion.newspaperTitleInputDtoMockA)
            .test()
            .expectSubscription()
            .assertNext {
                Assertions.assertEquals(NewspaperMockData.Companion.newspaperTitleMockA, it.body)
            }
            .verifyComplete()
    }
    ...
    fun `createTitle should return 400 bad request if request body object title is empty`() {
        titleController.createTitle(NewspaperMockData.Companion.newspaperTitleInputDtoMockA.copy(name = ""))
            .test()
            .expectErrorMatches {
    ...
    fun `createTitle should return BadRequestBodyException if startDate is after endDate`() {
        ...
        titleController.createTitle(NewspaperMockData.Companion.newspaperTitleInputDtoMockA.copy(startDate = startDate, endDate = endDate))
            .test()
            .expectErrorMatches {
                it is BadRequestBodyException &&
    ...
    fun `createTitle should call create publisher if publisher is present on request body`() {
        ...
        titleController.createTitle(NewspaperMockData.Companion.newspaperTitleInputDtoMockA.copy(publisher = "Pub", publisherPlace = null))
            .test()
            .expectSubscription()
            .assertNext {
                Assertions.assertEquals(NewspaperMockData.Companion.newspaperTitleMockA, it.body)
    ...
    fun `createTitle should call createPublisherPlace if publisherPlace is present on request body`() {
        ...
        titleController.createTitle(NewspaperMockData.Companion.newspaperTitleInputDtoMockA.copy(publisherPlace = "Pub"))
            .test()
            .expectSubscription()
            .assertNext {
                Assertions.assertEquals(NewspaperMockData.Companion.newspaperTitleMockA, it.body)
    ...
    fun `createTitle should call createLanguage if language is present on request body`() {
        every { newspaperService.createLanguage(any(), any()) } returns Mono.just(Language("nob", "1"))
        every { newspaperService.createNewspaperTitle(any()) } returns Mono.just(NewspaperMockData.Companion.newspaperTitleMockA.copy())
        titleController.createTitle(NewspaperMockData.Companion.newspaperTitleInputDtoMockA.copy(language = "nob", publisherPlace = null))
            .test()
            .expectSubscription()
            .assertNext {
                Assertions.assertEquals(NewspaperMockData.Companion.newspaperTitleMockA, it.body)
    ...
    fun `createTitle should not call on createPublisher, createPublisherPlace or createLanguage if not present on request body`() {
        val titleInput = NewspaperMockData.Companion.newspaperTitleInputDtoMockA.copy(publisher = null, publisherPlace = null, language = null)
        val title = NewspaperMockData.Companion.newspaperTitleMockA.copy(publisher = null, publisherPlace = null, language = null)
    ...
    fun `createTitle should continue when createPublisher receives a 409 conflict`() {
        ...
        every { newspaperService.createLanguage(any(), any()) } returns Mono.just(Language("nob", "1"))
        every { newspaperService.createNewspaperTitle(any()) } returns Mono.just(NewspaperMockData.Companion.newspaperTitleMockA.copy())
        titleController.createTitle(NewspaperMockData.Companion.newspaperTitleInputDtoMockA.copy(publisher = "Schibsted"))
            .test()
            .expectSubscription()
            .assertNext {
                Assertions.assertEquals(NewspaperMockData.Companion.newspaperTitleMockA, it.body)
    ...
    fun `createTitle should continue when createPublisherPlace receives a 409 conflict`() {
        ...
        every { newspaperService.createLanguage(any(), any()) } returns Mono.just(Language("nob", "1"))
        every { newspaperService.createNewspaperTitle(any()) } returns Mono.just(NewspaperMockData.Companion.newspaperTitleMockA.copy())
        titleController.createTitle(NewspaperMockData.Companion.newspaperTitleInputDtoMockA.copy(publisherPlace = "Oslo"))
            .test()
            .expectSubscription()
            .assertNext {
                Assertions.assertEquals(NewspaperMockData.Companion.newspaperTitleMockA, it.body)
    ...
    fun `createTitle should continue when createLanguage receives a 409 conflict`() {
        ...
        every { newspaperService.createNewspaperTitle(any()) } returns Mono.just(NewspaperMockData.Companion.newspaperTitleMockA.copy())
        titleController.createTitle(NewspaperMockData.Companion.newspaperTitleInputDtoMockA.copy(language = "nob"))
            .test()
            .expectSubscription()
            .assertNext {
                Assertions.assertEquals(NewspaperMockData.Companion.newspaperTitleMockA, it.body)
