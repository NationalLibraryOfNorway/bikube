...
class CollectionsServiceConfig (
    ...
    fun collectionsNewspaperService(): CollectionsService {
        return CollectionsService(collectionsWebClient, CollectionsDatabase.NEWSPAPER, maxitService)
    }
    ...
    fun collectionsEphemeraService(): CollectionsService {
        return CollectionsService(collectionsWebClient, CollectionsDatabase.EPHEMERA, maxitService)
    }
}
